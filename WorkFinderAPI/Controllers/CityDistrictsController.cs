...
namespace WorkFinderAPI.Controllers
{
    ...
    public class CityDistrictsController : ControllerBase
    {
		...
		private JsonConvertor jsonConvertor = null;
        ...
        public ActionResult<string> Get()
        {
			...
			{
				JObject cityDistrict = jsonConvertor.toJson(item);
        ...
        public string Get(int id)
        {
			...
			jObject = jsonConvertor.toJson(cityDistrict);
        ...
        public string Post([FromBody] JObject value)
        {
			...
			CityDistricts newCityDistrict = jsonConvertor.fromJsonToCityDistricts(value);
